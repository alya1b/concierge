...
namespace ConciergeWebApplication.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(ConciergeContext context)
        {
            _context = context;
        }
        ...
        {
            var conciergeContext = _context.Payments.Include(p => p.Apartment);
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,Date,Status,Sum,ApartmentId")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,Date,Status,Sum,ApartmentId")] Payment payment)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ConciergeContext.Payments'  is null.");
            }
            var payment = await _context.Payments.FindAsync(id);
            if (payment != null)
            {
